...
void GameAssign2::Init()
{
	...
	//create package
	resourceManager.CreateResourcePackage({ "meme.tga" });
	
	//load resources
	ResourceBundle* pBundle = resourceManager.LoadResources({ "meme.tga" });

	m_pTexture = pBundle->GetTexture("meme.tga");
 ...
 //   archiver.AddToUncompressedPackage(HashString("Object 1"), HashString("DummyStruct"), sizeof(DummyStruct), &object1);
 //   archiver.AddToUncompressedPackage(HashString("Object 2"), HashString("DummyStruct2D"), sizeof(DummyStruct2D), &object2);
 //   archiver.AddToUncompressedPackage(HashString("Test String"), HashString("String"), sizeof(testString), testString);
	//archiver.AddToUncompressedPackage(HashString("Test String 2"), HashString("String"), sizeof(testString2), testString2);
 ...
 //   size_t testStringSize = archiver.ReadRequiredSizeForPackageData(testStringHash);
	//size_t testStringTypeHash;
 //   void* decompressedTestStringData = MemoryManager::GetInstance().Allocate(testStringSize, 1, "Test String Decompressed");
 //   archiver.ReadPackageData(testStringHash, testStringTypeHash, decompressedTestStringData, testStringSize);
